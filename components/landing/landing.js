      ...
      <header class="z-30 flex items-center w-full h-24 sm:h-32">
        <div class="container flex items-center justify-between px-6 mx-auto">
          <div class="flex items-center text-3xl font-black text-gray-800 uppercase dark:text-white">
            ...
            <span class="mt-1 ml-3 text-xs">cecepjanuardi31@gmail.com</span>
          </div>
          <div class="flex items-center">
            <nav class="items-center hidden text-lg text-gray-800 uppercase font-sen dark:text-white lg:flex">
              <Link href="/blog" class="flex px-6 py-2 hover:text-black">
                Blog
              </Link>
              <Link href="/chat" class="flex px-6 py-2 hover:text-black">
                Chat
              </Link>
              <Link href="/dashboard" class="flex px-6 py-2 hover:text-black">
                Dashbord
              </Link>
            </nav>
